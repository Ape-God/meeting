...
ChatMessage::ChatMessage(QWidget* parent) : QWidget(parent)
{
    ...
    m_leftPixmap = QPixmap(":/meetingClient/src/defaultAvatar.jpg");
    m_rightPixmap = QPixmap(":/meetingClient/src/defaultAvatar.jpg");

    m_loadingMovie = new QMovie(this);
    m_loadingMovie->setFileName(":/meetingClient/src/loding.gif");
